...
namespace roots
{
    public class RootApp
    {
        ...
        public static RootApp Current
        {
            get { return current; }
        }
        private static RootApp current;
        ...
        public static void StartLocationService()
        {
            ...
            new Task(() => {
                ...
                Log.Debug("RootApp", "Calling StartService");
        ...
        public static void StopLocationService()
        {
            ...
            Log.Debug("RootApp", "StopLocationService");

            // Unbind from the LocationService; otherwise, StopSelf (below) will not work:
            if (locationServiceConnection != null)
            {
                Log.Debug("RootApp", "Unbinding from LocationService");
            ...
            {
                Log.Debug("RootApp", "Stopping the LocationService");
