...
{
    public class generic_note_fragment : DialogFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.generic_note_layout, container, false);
        ...
        private void InitalizeLocalControls(View view)
        {
            ...
            AddNoteButton = view.FindViewById<Button>(Resource.Id.add_new_note_button);
            NoteText = view.FindViewById<EditText>(Resource.Id.note_details);
        }
